# ASTUMSJ-Bootcamp
# This repository is created for the tasks I will do on the ASTUMSJ-Bootcamp

Repository: tofikoabdu1/astumsj-bootcamp
Files analyzed: 25

Estimated tokens: 43.6k

Directory structure:
└── tofikoabdu1-astumsj-bootcamp/
    ├── README.md
...
================================================
FILE: color-palette-picker/README.md
================================================
# React + Vite
...
================================================
FILE: color-palette-picker/eslint.config.js
================================================
...
================================================
FILE: color-palette-picker/index.html
================================================
<!doctype html>
<html lang="en">
  <head>
...
================================================
FILE: color-palette-picker/package-lock.json
================================================
{
...
================================================
FILE: color-palette-picker/package.json
================================================
{
  "name": "color-palette-picker",
  "private": true,
...
================================================
FILE: color-palette-picker/vite.config.js
================================================
...
================================================
FILE: color-palette-picker/.gitignore
================================================
# Logs
logs
*.log
...
================================================
FILE: color-palette-picker/src/App.css
================================================
#root {
  max-width: 1280px;
  margin: 0 auto;
...
================================================
FILE: color-palette-picker/src/App.jsx
================================================
...
================================================
FILE: color-palette-picker/src/index.css
================================================
* {
  padding: 0;
  margin: 0;
...
================================================
FILE: color-palette-picker/src/main.jsx
================================================
...
================================================
FILE: color-palette-picker/src/components/card.css
================================================
.card {
  max-width: 450px;
  margin: 0 auto;
...
================================================
FILE: color-palette-picker/src/components/Card.jsx
================================================
...
================================================
FILE: color-palette-picker/src/components/ColorButton.css
================================================



================================================
FILE: color-palette-picker/src/components/ColorButton.jsx
================================================
import React from "react";
...
================================================
FILE: color-palette-picker/src/components/colorpreview.css
================================================
.preview {
  padding: 20px;
...
================================================
FILE: color-palette-picker/src/components/ColorPreview.jsx
================================================
import React from "react";
...
================================================
FILE: kawaii-todo-list/README.md
================================================
# Kawaii TodoList
...
================================================
FILE: kawaii-todo-list/index.html
================================================
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Kawaii To-Do List</title>
    <link rel="stylesheet" href="style.css">
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <link href="https://fonts.googleapis.com/css2?family=Carter+One&family=Libertinus+Mono&display=swap" rel="stylesheet">
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <link href="https://fonts.googleapis.com/css2?family=Carter+One&family=Libertinus+Mono&family=Reem+Kufi+Ink&family=Reem+Kufi:wght@400..700&display=swap" rel="stylesheet">
</head>
<body>

<div class="container">
    <div class="form">
        <h1>Kawaii TodoList</h1>
        ...
        <p>Task added sucessfully</p>
        <ul>
            <li>Go to market <span class="remove">✎ ❌</span></li>
            <li>to Practice code <span class="remove">✎ ❌</span></li>
            <li>to Learn new hadith <span class="remove">✎ ❌</span></li>
            <li>to Learn Arabic <span class="remove">✎ ❌</span></li>
        </ul>
        <img src="./assets/cute.png" alt="Cute Bunny" class="cute-bunny" width="50">
    </div>
</div>
...
================================================
FILE: kawaii-todo-list/style.css
================================================
body {
...
================================================
FILE: todo-list-project/README.md
================================================
# Todo-List-Project
...
<body>
    <div class="container">
        <div class="todo-app">
            <h2>To-Do List <img src="Assets/icon-2.png" alt="icon"></h2>
...
================================================
FILE: todo-list-project/Scripts/main.js
================================================
...
================================================
FILE: todo-list-project/Styles/style.css
================================================
*{
    margin: 0;
    padding: 0;
...
.container{
    ...
    min-height: 100vh;
    background: #020024;
    background: linear-gradient(92deg, rgba(2, 0, 36, 1) 0%, rgba(9, 9, 121, 1) 35%, rgba(0, 212, 255, 1) 100%);
    padding: 10px;
}
.todo-app{
    width: 100%;
    max-width: 540px;
    background: #736e91;
    background: linear-gradient(90deg, rgba(115, 110, 145, 1) 0%, rgba(9, 9, 179, 1) 35%, rgba(26, 138, 161, 1) 99%);
    margin: 100px auto 20px;
    padding: 40px 30px 70px;
    border-radius: 10px; 
    box-shadow: 0px 0px 28px 3px rgba(255,255,255,0.75);
...
ul li.checked::before{
    background-image: url(../Assets/checked-2.png);
}
ul li span{
    position: absolute;
    right: 0;
